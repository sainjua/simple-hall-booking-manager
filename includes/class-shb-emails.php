...
class SHB_Emails {
		...
		<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
			<div style="max-width: 600px; margin: 0 auto; padding: 20px;">
				...
				<table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
					<tr>
						<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Booking ID:', 'simple-hall-booking-manager' ); ?></strong></td>
						<td style="padding: 10px; border: 1px solid #ddd;">#<?php echo esc_html( $booking->id ); ?></td>
					</tr>
					<tr>
						<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Hall:', 'simple-hall-booking-manager' ); ?></strong></td>
						<td style="padding: 10px; border: 1px solid #ddd;"><?php echo esc_html( $hall->title ); ?></td>
					</tr>
					<tr>
						<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Date:', 'simple-hall-booking-manager' ); ?></strong></td>
						<td style="padding: 10px; border: 1px solid #ddd;"><?php echo esc_html( shb_format_date( $booking->booking_date ) ); ?></td>
					</tr>
					<tr>
						<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Time:', 'simple-hall-booking-manager' ); ?></strong></td>
						<td style="padding: 10px; border: 1px solid #ddd;"><?php echo esc_html( $slot->label . ' (' . date( 'g:i A', strtotime( $slot->start_time ) ) . ' - ' . date( 'g:i A', strtotime( $slot->end_time ) ) . ')' ); ?></td>
					</tr>
					<tr>
						<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Customer:', 'simple-hall-booking-manager' ); ?></strong></td>
						<td style="padding: 10px; border: 1px solid #ddd;"><?php echo esc_html( $booking->customer_name ); ?></td>
					</tr>
					<tr>
						<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Email:', 'simple-hall-booking-manager' ); ?></strong></td>
						<td style="padding: 10px; border: 1px solid #ddd;"><a href="mailto:<?php echo esc_attr( $booking->customer_email ); ?>"><?php echo esc_html( $booking->customer_email ); ?></a></td>
					</tr>
					<?php if ( $booking->customer_phone ) : ?>
						<tr>
							<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Phone:', 'simple-hall-booking-manager' ); ?></strong></td>
							<td style="padding: 10px; border: 1px solid #ddd;"><?php echo esc_html( $booking->customer_phone ); ?></td>
						</tr>
					<?php endif; ?>
					<?php if ( $booking->event_purpose ) : ?>
						<tr>
							<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Event Purpose:', 'simple-hall-booking-manager' ); ?></strong></td>
							<td style="padding: 10px; border: 1px solid #ddd;"><?php echo esc_html( $booking->event_purpose ); ?></td>
						</tr>
					<?php endif; ?>
					<?php if ( $booking->attendees_count ) : ?>
						<tr>
							<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Attendees:', 'simple-hall-booking-manager' ); ?></strong></td>
							<td style="padding: 10px; border: 1px solid #ddd;"><?php echo esc_html( $booking->attendees_count ); ?></td>
						</tr>
					<?php endif; ?>
				</table>
	...
	private function get_guest_pending_template( $booking, $hall, $slot, $booking_dates = array() ) {
		...
		<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
			<div style="max-width: 600px; margin: 0 auto; padding: 20px;">
				<h2 style="color: #0073aa;"><?php esc_html_e( 'Booking Request Received', 'simple-hall-booking-manager' ); ?></h2>
				
				<p><?php printf( esc_html__( 'Dear %s,', 'simple-hall-booking-manager' ), esc_html( $booking->customer_name ) ); ?></p>
				
				<p><?php esc_html_e( 'Thank you for your booking request. We have received your request and will review it shortly.', 'simple-hall-booking-manager' ); ?></p>
				...
				<table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
					...
					<tr>
						<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Dates:', 'simple-hall-booking-manager' ); ?></strong></td>
						<td style="padding: 10px; border: 1px solid #ddd;">
							<p><strong><?php echo sprintf( _n( '%d day booking', '%d days booking', count( $booking_dates ), 'simple-hall-booking-manager' ), count( $booking_dates ) ); ?></strong></p>
					...
					<tr>
						<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Status:', 'simple-hall-booking-manager' ); ?></strong></td>
						<td style="padding: 10px; border: 1px solid #ddd;"><strong style="color: #d63638;"><?php esc_html_e( 'Pending', 'simple-hall-booking-manager' ); ?></strong></td>
					</tr>
				</table>
				
				<p><?php esc_html_e( 'You will receive another email once your booking has been confirmed or if any changes are made.', 'simple-hall-booking-manager' ); ?></p>
				
				<div style="background: #f0f7ff; border: 2px solid #0073aa; border-radius: 5px; padding: 15px; margin: 20px 0;">
					<p style="margin: 0 0 10px 0;"><strong><?php esc_html_e( 'Your Booking Access PIN:', 'simple-hall-booking-manager' ); ?></strong></p>
					<p style="font-size: 32px; font-family: 'Courier New', monospace; background: #fff; padding: 15px; border-radius: 3px; margin: 10px 0; letter-spacing: 4px; text-align: center; color: #0073aa; font-weight: bold;">
		...
		<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
			<div style="max-width: 600px; margin: 0 auto; padding: 20px;">
				...
				<table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
					...
					<tr>
						<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Status:', 'simple-hall-booking-manager' ); ?></strong></td>
						<td style="padding: 10px; border: 1px solid #ddd;"><strong style="color: #00a32a;"><?php esc_html_e( 'Confirmed', 'simple-hall-booking-manager' ); ?></strong></td>
					</tr>
				</table>
				
				<p><?php esc_html_e( 'We look forward to seeing you! If you have any questions, please don\'t hesitate to contact us.', 'simple-hall-booking-manager' ); ?></p>
				
				<div style="background: #d4edda; border: 2px solid #28a745; border-radius: 5px; padding: 15px; margin: 20px 0;">
					<p style="margin: 0 0 10px 0;"><strong><?php esc_html_e( 'Your Booking Access PIN:', 'simple-hall-booking-manager' ); ?></strong></p>
					<p style="font-size: 32px; font-family: 'Courier New', monospace; background: #fff; padding: 15px; border-radius: 3px; margin: 10px 0; letter-spacing: 4px; text-align: center; color: #28a745; font-weight: bold;">
						<?php echo esc_html( $booking->pin ); ?>
					</p>
		...
		<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
			<div style="max-width: 600px; margin: 0 auto; padding: 20px;">
				...
				<table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
					...
					<tr>
						<td style="padding: 10px; background: #f5f5f5; border: 1px solid #ddd;"><strong><?php esc_html_e( 'Status:', 'simple-hall-booking-manager' ); ?></strong></td>
						<td style="padding: 10px; border: 1px solid #ddd;"><strong style="color: #d63638;"><?php esc_html_e( 'Cancelled', 'simple-hall-booking-manager' ); ?></strong></td>
					</tr>
				</table>
				
				<p><?php esc_html_e( 'If you have any questions, please feel free to contact us.', 'simple-hall-booking-manager' ); ?></p>
			</div>
		</body>
		</html>
		<?php
