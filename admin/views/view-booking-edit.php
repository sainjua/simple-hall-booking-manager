	...
	<form method="post" action="">
		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<code style="font-size: 16px; font-weight: bold; background: #f0f7ff; padding: 5px 10px; border-radius: 3px; letter-spacing: 2px;">
			...
			<tr>
				...
				<td>
					<?php if ( 'multiday' === $booking->booking_type ) : ?>
						<span class="shb-multiday-badge" style="background: #2271b1; color: #fff; padding: 3px 8px; border-radius: 3px;">
				...
				<tr>
					...
					<td>
						<div style="margin-bottom: 10px;">
							<strong><?php echo sprintf( _n( '%d day', '%d days', count( $booking_dates ), 'simple-hall-booking-manager' ), count( $booking_dates ) ); ?></strong>
						</div>
						...
						<?php else : ?>
							<p class="description"><?php esc_html_e( 'No dates found for this booking.', 'simple-hall-booking-manager' ); ?></p>
						<?php endif; ?>
					</td>
				</tr>
			<?php else : ?>
				<tr>
					<th><?php esc_html_e( 'Date', 'simple-hall-booking-manager' ); ?></th>
					<td><?php echo ! empty( $booking_dates ) ? esc_html( shb_format_date( $booking_dates[0]->booking_date ) ) : '-'; ?></td>
				</tr>
			<?php endif; ?>
			<tr>
			...
			<tr>
				...
				<td><?php echo esc_html( shb_format_date( $booking->created_at ) . ' ' . date( 'g:i A', strtotime( $booking->created_at ) ) ); ?></td>
			</tr>
			<tr>
		...
		<table class="form-table">
			<tr>
				...
				<td>
					...
					<p class="description"><?php esc_html_e( 'Changing the status will send an email to the customer.', 'simple-hall-booking-manager' ); ?></p>
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<textarea name="admin_notes" id="admin_notes" rows="4" class="large-text"><?php echo esc_textarea( $booking->admin_notes ); ?></textarea>
					<p class="description"><?php esc_html_e( 'Internal notes (not visible to customer)', 'simple-hall-booking-manager' ); ?></p>
				</td>
			</tr>
		</table>

		<p class="submit">
			<input type="submit" name="shb_save_booking" class="button button-primary" value="<?php esc_attr_e( 'Update Booking', 'simple-hall-booking-manager' ); ?>">
