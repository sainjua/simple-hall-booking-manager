		...
		<div class="shb-conflict-box">
			...
			<div>
				...
				<p style="margin: 0; color: #7c2d12; font-size: 13px; line-height: 1.5;">
					...
					printf(esc_html__('This booking conflicts with %d potentially pending booking(s). Approving will automatically cancel overlapping pending requests.', 'simple-hall-booking-manager'), count($conflicts));
					?>
				</p>
			</div>
		</div>
