 ...
 * Plugin URI: https://github.com/yourusername/simple-hall-booking-manager
 * Description: A lightweight WordPress plugin to manage hall bookings with full-day vs partial slot logic, guest bookings (no login), and a clean admin UI.
 * Version: 1.0.0
 * Author: Your Name
